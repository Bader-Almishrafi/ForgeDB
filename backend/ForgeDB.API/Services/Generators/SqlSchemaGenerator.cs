...
public class SqlSchemaGenerator : IDesignSchemaGenerator
{
        ...
        List<DesignRelationshipSnapshot>? inlineForeignKeys)
    {
        ...
        {
            var identity = column.IsAutoIncrement ? " GENERATED BY DEFAULT AS IDENTITY" : string.Empty;
            ...
            var defaultValue = !column.IsAutoIncrement && !string.IsNullOrWhiteSpace(column.DefaultValue)
                ? $" DEFAULT {column.DefaultValue}"
                : string.Empty;
            lines.Add($"    {Quote(column.Name)} {column.SqlType}{identity}{defaultValue}{nullability}{uniqueness}");
        }
